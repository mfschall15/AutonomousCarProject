# -*- coding: utf-8 -*-
"""
Created on Sun Apr 24 00:06:49 2022
...
filename = './sim_dataset_full/6/6_1.jpg'
...
class Lane:
  ...
  def __init__(self, orig_frame):
    ...
    self.roi_points = np.float32([
      (90,60), # Top-left corner
      (0, 145), # Bottom-left corner            
      (250,136), # Bottom-right corner
      (170,60) # Top-right corner
    ])
  ...
  def get_line_markings(self, frame=None):
    ...
    _, sxbinary = edge.threshold(hls[:, :, 1], thresh=(250, 255))
    ...
    self.lane_line_markings = cv2.morphologyEx(self.lane_line_markings, cv2.MORPH_CLOSE, kernel)
  ...
  def plot_roi(self, frame=None, plot=False):
    ...
    this_image = cv2.polylines(frame, np.int32([
      self.roi_points]), True, (120,200,255), 3)
...
def main():
  ...
  cv2.imshow('orig', original_frame)
